...
actor HuyaLiveService {
    ...
    func getPlayURLs(detail: LiveRoomDetail, quality: LivePlayQuality) async throws -> LivePlayResult {
        ...
        guard !flvURLs.isEmpty else { throw NetworkError.message("虎牙无可用 FLV 播放地址") }
        return LivePlayResult(urls: flvURLs, headers: [
            "User-Agent": playUA,
